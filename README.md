...
local StarServer = Star:Server("Xenon hub",8521503225)
	...
	while game:GetService("RunService").RenderStepped:wait() do
		if _G.AutoFarmtp then
			pcall(function()
			 ...
			 RigC.activeController.hitboxMagnitude = 10000
...
local credit = StarServer:Channel("credit")

credit:Slider("Aunter",function(Value)
    Aunter = Value
end)
